# Ordre du jour de la rencontre du vendredi ~2024-08-21~ 2024-08-30  
...
.1.2.  Acquisitions :  
.1.2.1 Gikfun Lot de 10 paires de diodes infrarouges et de récepteurs VS1838B pour Arduino (EK8460) (G)  
.1.2.2 Modules (2) CH340G pour brancher/programmer les modules (5) ESP8266 ESP-01S acquis précédemment (G)  
.1.2.3 Lot de 2600 résistances à 130 valeurs (G)  
.1.2.4 Casque d'écoute Bose Quiet Comfort Ultra (G)  
.1.2.5 « Rivets-poussoirs » en platique (deux dimensions) (D)  
.1.2.6 Boulons M3 40 mm, 45 mm et 50 mm (D)  
.1.2.7 Arduino Due (original); voir 3.1.3. (D)  
.1.2.8 Lot de 2 convertisseurs de tension DC-DC LM2596 réglables (D)  
.1.2.9 Divers manchons de protection pour câbles (D)  
.1.2.10 Roland AIRA Compact S-1 Tweak Synthetiser (D)  
...
3 Robotique 🤖  
.3.1 **Projet KVA** (D) :   
..3.1.1 Boîtier de batteries : terminé  
..3.1.2 Boîtier avant pour circuit de « debouncing » et plaquette Popolu micro : boîte terminée mais couvercle en développement  
..3.1.3 Arduino Due sauté/pas sauté  ;)  
..3.1.4 Impression 3D d'un support pour capteur ultrasonique HC-SR04  
..3.1.5 Intégration de l'IMU (MPU9250 / Teensy 3.2)  suite du projet  
...
Breuvages disponibles :
  ...
  * Rye Canadian Club Rye 🥃  
  * Scotch Johnnie Walker Red Label 🥃
  * Scotch Chivas Regal 🥃  
  * Whisky Sour et Old Fashioned disponibles sur demande  
  * McNicol disponible sur demande (version Kilkenny)  
