# Ordre du jour de la rencontre du mercredi 2024-08-14  
 *Changement de journée (dorénavant le mercredi) à la demande générale d'Andrée*  
...
.1.2.  Acquisitions :  
.1.2.1 Roulette de filament PLA et assortiment d'écrous et boulons M3 (D).  
.1.2.2 Système d'emballage sous-vide pour roulette de filament 3D (D)  
.1.2.3 KeeYees Modules (5) Arduino Nano V3.0 (G)  
.1.2.4 Gikfun Lot de 10 paires de diodes infrarouges LED pour Arduino EK8460 (G) à recevoir  
.1.2.5 Modules (2) CH340G pour brancher/programmer les modules (5) ESP8266 ESP-01S acquis précédemmen (G) à recevoir  
.1.2.6 Lot de 2600 résistances à 130 valeurs (G) à recevoir  
...
3 Robotique 🤖  
.3.1 **Projet KVA** (D) :   
..3.1.1 Boîtier de batteries :  
...3.1.1.1 Travail de conception dans FreeCad  
...
.5.2 **Impression 3D** (D)  
..5.2.1 Fin d'assemblage de la Original Prusa MK4 : deux problèmes rencontrés  
..5.2.2 Deux tests d'impression  
..5.2.3 Une première pièce de production  
...
..7.1.1 ~~La Guerre du pacifique n'aura pas lieu (retrouvé chez G par G le 2024-07-13)~~  
...
Breuvages disponibles :
  ...
  * McNicol disponibles sur demande (version Kilkenny)  
