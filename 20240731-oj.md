...
.1.2.  Acquisitions :  
.1.2.1 Imprimante Original Prusa MK4 3D Printer kit (D).  
...
3 Robotique 🤖  
.3.1 **Projet KVA** (D) :   
..3.1.1 Détection de collision (avant) :  
...3.1.1.1 Circuit de « debouncing » pour les capteurs de collisions, version de production sur plaquette de prototypage à souder  
...3.1.1.2 Tests du circuit de production sur le véhicule (une version du code opérationnel)  
