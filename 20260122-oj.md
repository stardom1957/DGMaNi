...
..4.1.1.1 ***Production de fichiers .3mf et .stl pour passer à l'étape de production suivante*** 

5 Autres  
.5.1 **Blog** (G)  
..5.1.1 **Voyage 2025**  
...5.1.1.1 Suite d'articles concernant le voyage dans certains pays de l'est que je viens d'effectuer avec J  
...5.1.1.2 ***Il ne reste que la fin du voyage à montrer (Stans, Innsbruck)***  
...
7 ***DGMaNi***  
.7.1 ***Numérotation des fichiers cr et oj dans les archives (G)***  
.7.1.1 ***2022 et 2023 sont faits*** 
