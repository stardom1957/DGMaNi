# Ordre du jour de la rencontre du vendredi 2024-10-18  
...
..1.1.1 Discussion de différents films de Terry Pratchett vus par (D) et (G) sur Prime  
..1.1.1.1 The Color of Magic  
..1.1.1.2 Hogfather  
..1.1.1.3 Going Postal  
..1.1.2 Discussion de **Tubular Bell 50e Anniversary Concert** sur youtube vu par (D)  
.1.2.  Acquisitions :  
.1.2.1 Roland Aira Compact J-8 Chord Synth (D)  
.1.2.2 Roland Aira Compact T-8 Beat Machine (D)  
.1.2.3 Clavier Arturia _KeyStep 37 Controller (D)  
.1.2.4 Livre « PATCH & TWEAK EXPLORING MODULAR SYNTHESIS »  (D) (attendu ce vendredi)  
...
3 Robotique 🤖  
.3.1 **Projet KVA** (D) :   
..3.1.1 IMU : Teensy 3.2 et MPU9250 suite.  
...
.6.10 ~~Prêt de (G) à (D) du coffret CD avec les trames sonores de Myst. Remis par (D) le 2024-10-18~~  
7 Du coq à l'âne  
.7.1 Nouveaux emprunts? (G)   
..7.1.1 Prêt de (D) à (G) du kit DAVID PAL36 et accessoires (câbles, lunettes, bidule et manuel) dans contenant plastique

8 Entièrement ludique  
.8.1 Nano-concert Roland S-1, J-6 et T-8 par (D)  

Breuvages disponibles :
  * Bourbon Bulleit 🥃  
  * Scotch Johnnie Walker Red Label 🥃
  * Whisky Irlandais Jameson (restant de mon beau-pêre)  
