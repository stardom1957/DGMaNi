...
.1.2.  Acquisitions :  
.1.2.1 Prusa : 2 roulettes de filament PETG et tête d'extrusion renforcée (D).  
.1.2.2 Pompe pour système d'emballage sous-vide pour sacs EIBOS (D)  
.1.2.3 Cassettes de silicate dessicant (D)  
.1.2.4 Rivets poussoir en plastique (D)  
.1.2.5 Meuble pour imprimante 3D (D)  
...
...3.1.1.1 **Lancement de l'impression 3D du prototype du boîtier**  
...3.1.1.2 Prototypes pour la quincaillerie dans des pièces en plastique (boulons et écrous)  
...
Breuvages disponibles :
  ...
  * Scotch Glen Deveron 16 ans 🥃  
  * Whisky Sour et Old Fashioned disponibles sur demande  
  * McMartel disponibles sur demande (version Guinness)  
