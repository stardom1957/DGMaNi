# Ordre du jour de la rencontre du vendredi 2025-02-28  
Lieu :    Chez Dominique  🎄🏠🌳🌲🌵    
...
.4.1 **Impression 3D :**  
..4.1.1. Poursuite de l'apprentissage de FreeCAD (G)  
...4.1.1.1 Expérimentation avec les Lofts pour faire des quetras
...4.1.1.2 Modèle 3D d'une quetra en platiscine (Play-Doh) 

5 Autres  
.5.1 **Blog** (G)  
..5.1.1 **Défi A à Z : L'écriture est ...**  
...5.1.1.1 Défi terminé, bilan déposé!   
...
..8.1.1. On se met dans le « Moog »!   
..8.1.2. Quelques mesures à l'aide de l'oscilloscope.  
.8.2. Prise de photos des divers modules (G)  
